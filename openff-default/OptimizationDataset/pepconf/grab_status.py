...
#subsets = ['OpenFF Gen 2 Opt Set 1 Roche', 'OpenFF Gen 2 Opt Set 2 Coverage', 'OpenFF Gen 2 Opt Set 3 Pfizer Discrepancy', 'OpenFF Gen 2 Opt Set 4 eMolecules Discrepancy', 'OpenFF Gen 2 Opt Set 5 Bayer']
subsets = ['OpenFF PEPCONF OptimizationDataset v1.0']

for subset in subsets:
    ds = client.get_collection('OptimizationDataset', subset)
    logging.info(ds.status(["default"]))
    logging.info('-------------------')
